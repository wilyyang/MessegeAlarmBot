...
class HiltChatbotDatabase {
    ...
    @Singleton
    @Provides
    fun provideQuizDatabaseDao(databaseHelper : ChatBotDatabaseHelper) : QuizDatabaseDao = databaseHelper.quizDatabaseDao()

    @Singleton
    @Provides
    fun providePartyDatabaseDao(databaseHelper : ChatBotDatabaseHelper) : PartyDatabaseDao = databaseHelper.partyDatabaseDao()
}